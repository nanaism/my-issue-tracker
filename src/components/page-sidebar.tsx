...
export function PageSidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-[#FFFFF0] backdrop-blur-sm border-r border-stone-200 flex flex-col shadow-sm z-20">
      {/* サイドバーヘッダー */}
      <div className="p-4 border-b border-stone-200">
        <h1 className="text-2xl font-sans font-bold text-stone-800">
          Todo管理er
        </h1>
      </div>
